...
<div x-data="{ 
    ...
    <div x-cloak x-ref="sidebar"
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-100 bg-indigo-50">
            ...
            <button @click="toggle()" class="lg:hidden p-2 text-indigo-600 hover:bg-white rounded-lg transition-colors">
