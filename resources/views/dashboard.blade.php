...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-white shadow-xl flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <!-- Link Transaksi -->
            <a href="transaksi" class="flex items-center px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg transition duration-200">
    ...
    <a href="#" class="flex items-center mx-4 px-4 py-2 text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition duration-200">
